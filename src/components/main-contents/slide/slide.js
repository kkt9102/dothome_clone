      ...
      <Slider {...Setting}>
        <div className="items item_1">
          <div className="relative">
            ...
            <div className="sub_tit">다양한 템플릿과 디자인 블럭으로<br/>
초보자도 쉽고 빠르게 홈페이지를 만들 수 있습니다.</div>
          <a href="" className="flex flex_jc_c flex_ai_c">자세히 보기</a>
          </div>
        </div>
        ...
        <div className="items item_3">
          <div className="relative">
            ...
            <div>할인쿠폰으로 가격부담없이 신규 도메인을 신청해보세요!(net/org/biz/info/pe.kr 제외)</div>
            <a href="" className="flex flex_jc_c flex_ai_c">자세히 보기</a>
          </div>
        </div>
        ...
        <div className="items item_5">
          <div className="relative">
            ...
            <div className="sub_tit">SSL보안인증서를 설치하여 웹사이트를 안전하게 보호하세요.<br/>
