...
export const CustomerSection = {
  CustomerFrame:styled.div`
    ...
    .btn_box {position:relative; max-width:33.5%; margin: 3rem auto 3rem auto;
      button {padding:1.55rem 3.6rem; margin:0 0.7rem; background:#009cff; border-radius:0.3rem; font-size:1.4rem; font-weight:600; color:#ffffff; transition:background 0.3s;
