...
export const HeaderSection = {
  HeaderFrame:styled.div`
    ...
    nav {display: flex; justify-content: space-between; align-items:center; flex-basis:100%; width:117rem; height:8rem; margin:0 auto;}
    ...
    .right_menu { 
      li {position:relative; height: inherit; 
        ...
        &:not(:last-child)::after {content:""; position:absolute; width:0.1rem; height:1.3rem; top:20%; right:0; background:#999999;}
      }
    }
